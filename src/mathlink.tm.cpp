...
#endif
{
	...
	if (_res) _res = _definepattern(mlp, (char *)"SigmaRadCone[order_, nf_, _mW_, Mz_, aMz_, aQED_, gammaZ_, sin2ThetaW_,                 mQ_, muQ_, mCharm_, muCharm_, x_, theta_, deltaTheta_, q_, mu_]", (char *)"{order, nf, mW, Mz, aMz, aQED, gammaZ, sin2ThetaW, mQ, muQ, mCharm,                 muCharm, x, theta, deltaTheta,                  q, mu}", 8);
